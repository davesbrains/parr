        ...
        execute: function() {
            ContactComponent = (function () {
                ...
                ContactComponent.prototype.cancel = function (showToast) {
                    ...
                    if (showToast) {
                        this._toastService.activate("Cancelled changes to " + this.contact.name);
                    }
                };
                ContactComponent.prototype.delete = function () {
                    var _this = this;
                    var msg = "Do you want to delete " + this.contact.name + "?";
                    this._modalService.activate(msg).then(function (responseOK) {
                        if (responseOK) {
                            _this.cancel(false);
                            _this._contactService.deleteContact(_this.contact)
                                .subscribe(function () {
                                _this._toastService.activate("Deleted " + _this.contact.name);
                                _this._gotoContacts();
                            });
                        }
                    });
                ...
                ContactComponent.prototype.save = function () {
                    ...
                    if (contact.id == null) {
                        this._contactService.addContact(contact)
                            ...
                            _this._toastService.activate("Successfully added " + con.name);
                            _this._gotoContacts();
                        });
                        return;
                    }
                    this._contactService.updateContact(contact)
                        .subscribe(function () { return _this._toastService.activate("Successfully saved " + contact.name); });
                };
